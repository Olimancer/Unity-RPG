...
namespace Game.Characters.Enemies {
	...
	public class EnemyRangeAttack : MonoBehaviour {
		...
		[SerializeField] GameObject		_projectileToUse 			= null; // TODO: Fetch and set with programmation
		...
		Projectile SpawnProjectile() {
			...
			if (!_canDamageAlly) { projectile.gameObject.layer = (int)Layer.EnemyAttack; } // Place the projectile on the EnemyAttack layer to avoid collision with allies.
			return projectile;	
		}
